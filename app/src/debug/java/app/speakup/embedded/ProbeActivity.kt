 ...
 *
 *     adb shell am start -n app.speakup.debug/app.speakup.embedded.ProbeActivity
 */
class ProbeActivity : Activity() {
    ...
    companion object {
         ...
         * not a design.
         */
        const val DEFAULT_ROOT = "/data/local/tmp/speakup-probe"
    }
}
