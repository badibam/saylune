...
/** The theme, read the way Material's is: `Saylune.palette`, `Saylune.grid`, `Saylune.rhythm`. */
object Saylune {
    val palette: Palette
...
private val LocalPalette = staticCompositionLocalOf<Palette> {
    error("no palette: this is outside SayluneTheme")
}
private val LocalTypography = staticCompositionLocalOf<Typography> {
    error("no typography: this is outside SayluneTheme")
}
private val LocalGrid = staticCompositionLocalOf<Grid> {
    error("no grid: this is outside SayluneTheme")
}
private val LocalRhythm = staticCompositionLocalOf<Rhythm> {
    error("no marking rhythms: this is outside SayluneTheme")
}
