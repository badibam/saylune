...
**La sortie d'un passage bloqué est l'épuisement des tentatives, et c'est la seule.** Pas de geste d'abandon à part : les tentatives sont déjà un levier, donc la sortie est déjà réglable. Et l'IA **n'a rien à refabriquer** — l'appel avait rendu la continuation et l'écho ensemble, donc l'app joue la continuation qu'elle tenait. Aucun second appel, rien de rétracté.
