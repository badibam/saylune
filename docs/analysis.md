...
**Deux des trois dimensions sont mesurées, et elles ne portent rien** (2026-08-31, `bench/accent.py -b 0 -m aligné`, tout le jeu `test` : 2 591 mots pleins, 70 fautes d'accent). Seuil posé sur les mots à l'accent correct, à 5 % de fausse alerte : la **durée** voit 3 fautes sur 70, l'**intensité** 13, les deux ensemble 10. Un mot correct diverge plus que la pire des fautes, et six fautes divergent à 0,000. Ce ne sont pas des dimensions d'appoint faibles, ce sont des dimensions muettes — la brique ne peut pas s'écrire dessus. Ce qui reste à la forme est la **masse de réduction**, la dimension que les mesures d'accent classent première quand elle parle, et qui n'a jamais été lue en profil (`../TODO.md`, mesure 2), et le montage à hypothèses concurrentes (mesure 4).
...
Les mesures à faire, leur ordre, et le montage de repli (noter des hypothèses d'accent concurrentes sur la matrice) sont dans `../TODO.md`, « La brique 7 — réorientée ».
