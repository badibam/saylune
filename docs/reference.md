...
- `design/` (`design/grammar-test-set.md`, `design/local-chain.md`, `design/questions.md`, `design/harvest.md`) — le transitoire, qui s'élague quand il est consommé : les énoncés des deux bancs du chantier 2, qui n'ont jamais tourné ; le montage où la voix des personnages devient locale, avec les critères de ses mesures posés avant les chiffres ; ce que le modèle établit de la fiction, quand on le lui demande et où ça se relit ; et trois leçons d'établi qui attendent d'être poussées vers la sagesse.
