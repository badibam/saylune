...
La capture est un **levier de fluidité à trois positions**, décrit dans `activity.md` ; trois choses y sont décidées quelle que soit sa position : le micro **ne s'arme jamais avant la fin de la réponse de l'IA** ; un symbole est visible dès que ça enregistre ; et **chaque tour porte sa position de capture**, sans quoi rien ne dit si ses silences sont significatifs, et rien ne s'agrège entre positions.
