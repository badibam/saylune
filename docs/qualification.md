...
- `boundaries.py` — où le réseau place chaque son dans le temps. La seule qualification adossée à une **vérité terrain** plutôt qu'à notre jeu étiqueté : TIMIT annote chaque phone au niveau de l'échantillon. Elle rend deux choses de portée très différente : la **position** d'un son, bonne à 25 ms, qui est ce dont les briques 7 et 8 vivent ; et la **durée couverte**, à 26,9 %, qui **ne juge plus rien** — aucune brique ne lit l'étendue d'un son. Elle a longtemps servi à instruire le procès de la densité ; ce procès n'a plus de partie civile.
