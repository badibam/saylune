...
**Trois champs d'affichage s'y ajoutent, et ils viennent d'une contrainte d'écran** (2026-09-06, revu le 2026-09-07) : le **nom** de l'activité, que porte une tuile et un titre d'écran ; le même **coupé à dix caractères** pour la ligne d'état, qui n'a pas cette place ; et un **nom court** par personnage, que porte la ligne qui nomme chaque tour. Les deux premiers sont deux lecteurs à deux budgets, pas un champ et son repli. Les deux se tronquent de toute façon à l'affichage ; les déclarer laisse l'auteur choisir ce qui survit à la troncature au lieu de la subir. Le détail est dans `pixel-ui.md` (« La charpente », « La ligne qui nomme le tour »).
...
**Les quatre portes, et ce qui les sépare** (arrêté le 2026-09-06). L'app s'ouvre sur un **écran-titre qui les présente** ; chacune est une couche d'accès, et le même moteur tourne derrière.

- **Histoire** — un bloc à accès **ordonné**. Chaque scène est une définition, les questions déclarées portent la mémoire d'une scène à la suivante, et le niveau suivant s'ouvre si le résultat le dit.
- **Défis** — un bloc à accès **libre**. On choisit dans un recueil ; chaque défi a ses poids, ses consignes et ses règles, et rend une issue.
- **Arcade** — quatre définitions rejouées sans fin, une **rampe** qui durcit en cours de partie, la fin à zéro vie, et un **score** par difficulté plutôt qu'une réussite.
- **Libre** — **aucun enjeu** : pas de vies, pas de règle de fin, pas d'issue, aucune lettre. Ce n'est pas *sans réglages* : ses leviers sont réglables et posés par des préréglages ; c'est qu'aucun **écran de configuration** ne les expose en V1, ni avant ni pendant. L'entrée de la barre d'actions reste, **grisée en portant sa raison**, pour que la barre ne change pas de forme ensuite.

**Derrière la porte « Libre », des thèmes — et un thème est une définition** (2026-09-06). *« À la fin d'une conférence, tu engages la discussion avec l'intervenant »* est une situation, qui est l'intervenant et comment il parle est une mise en scène, tous les leviers restent ouverts et aucune règle n'est écrite. Donc quelques situations préenregistrées sont quelques fichiers, et **rien de neuf**. Le choix *personnalisé laissé vide* n'est pas un cas particulier non plus : c'est la définition qu'on livre déjà, dont la situation est vide.

**Ce qui est neuf est le trou.** Une définition peut déclarer des **emplacements** que l'apprenant remplit au lancement — une clé, une question dans sa langue, *« quelle est sa spécialité ? »*, deux ou trois mots. Trois choses les gouvernent. Le **même trou apparaît des deux côtés du `brief`**, et une seule réponse les remplit ensemble : écrits séparément, la situation et la mise en scène dérivent en spécificité dès le premier lancement — une conférence sur la neurophysique et une sur la théorie du genre ne font pas le même intervenant. La réponse est **substituée à la création** et copiée sur la ligne comme tout le reste, donc la séance se lit seule sans retrouver son gabarit. Et elle se tape dans **la langue que l'apprenant veut** : ce qui compte est qu'il décrive ce qui l'intéresse, pas ce qu'il sait écrire en anglais.

**Le genre se demande de la même façon, et sans rien déclarer** (2026-09-06). L'écran de lancement d'une libre porte toujours les deux, le champ court et le **genre**, dont le défaut est *peu importe* — qui n'est pas un troisième genre mais l'absence de contrainte, et fait **tirer au hasard** parmi les génériques dont l'apprenant dispose. Rejouer un thème ne redonne donc pas la même personne, ce qui sert la rencontre ; le tirage entre au journal comme tout ce qu'un hasard décide, et la voix tirée est copiée sur la ligne. **Ce qui dit qui décide est la présence du champ** : une définition qui déclare un genre l'impose, une qui n'en déclare pas se le fait demander. Il n'y a donc pas de drapeau *demandé* à écrire, et le personnage d'une séance ne porte jamais qu'une valeur résolue.
...
**Un drapeau est un événement nommé**, qu'un patch pose et qu'un déclencheur lit, sans rien afficher. **Trouvé en l'écrivant (2026-09-06) : aucune des six sortes de déclencheur n'en lit un**, et la liste est déclarée fermée. L'armement fait déjà le travail — un patch arme et désarme une règle par son nom, et la chaîne de drapeaux ci-dessous s'écrit elle-même en règles qui s'arment l'une l'autre. Le code replie donc le drapeau sur l'armement ; ce qui reste à dire est si la famille garde un nom à elle (`../../TODO.md`). C'est ce qui rend les embranchements d'une scène écrivables à l'intérieur d'une séance, là où les questions déclarées ne passent que d'une scène à la suivante (« Ce qui se souvient »).
...
**L'armement n'ouvre pas de vague** (tranché le 2026-09-06, trouvé en écrivant la surcharge). Une vague s'ouvre sur ce que les effets ont rendu **vrai** — une vie perdue, un seuil atteint —, et armer ne change aucun fait du monde : ça change quelles règles regardent. Sans cette séparation, la surcharge décrite plus bas s'effondre : la règle qu'on vient d'armer part dans le même souffle que celle qui l'a armée, donc ses deux phrases tombent au premier passage. Ce n'est pas revenir à une vague unique, et c'est mesuré : deux déclencheurs lisent l'état — un levier qui a **bougé**, un levier qui **atteint** une valeur — et les deux se font rendre vrais par un patch du moment même. Sans vagues, réagir à une vie perdue arriverait un passage trop tard, et la mort scriptée tomberait un passage après la mort.
...
**Le `brief` se coupe en deux, et pas plus** : la **situation**, que l'apprenant lit, et la **mise en scène**, qui ne s'adresse qu'au personnage et ne s'affiche jamais, sous peine de se saboter. **Ce qui les sépare est qui elles situent** (précisé le 2026-09-06), et ce n'est jamais le même texte : la situation situe **l'apprenant, à la deuxième personne** — *« à la fin d'une conférence sur la théorie du genre, tu engages la discussion avec l'intervenant »* —, la mise en scène situe le **personnage** — *« tu es le chercheur qui vient de donner cette conférence »*. Elles se répondent, et un emplacement rempli par l'apprenant les traverse toutes les deux. Aller plus loin empiéterait sur les consignes, qui sont déjà un champ à part avec leurs lecteurs et leur durée. Le prix de l'appel unique est ici, et il se dit une fois : la mise en scène est dans le contexte du juge, où elle n'a rien à faire, et ce qui l'en tient à distance est une phrase disant que son critère est la consigne. Ça se vérifie au banc, ça ne se prouve pas.
