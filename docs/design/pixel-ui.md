...
- **Les noms d'aptitude de l'élocution et de la fluidité**, qui titrent deux groupes de l'écran de bilan. Les onze noms de feuille sont trouvés, et avec eux les trois autres titres — `Grammaire`, `Pertinence`, `Compréhension` (`activity-model.md`, « Les noms d'écran »). Ces deux-là restent parce qu'ils n'avaient pas la contrainte qui a tranché les autres : leurs branches portent quatre feuilles chacune, donc rien ne risquait de se répéter.
