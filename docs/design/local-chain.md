...
8. **Fidélité verbatim de la reconnaissance locale.** Ce critère a été déplié dans `local-recognition.md`, qui le rend plus dur qu'il n'était écrit : ce n'est pas un critère de choix, c'est une condition de l'analyse du son, l'apprenant s'alignant sur tout ce qu'il a dit. CrisperWhisper n'y attend plus rien — sa licence non commerciale en fait une impasse et non une réserve —, et rien de libre ne rend le verbatim en anglais, donc la voie est l'entraînement.
