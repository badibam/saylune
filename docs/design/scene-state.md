...
**Une consigne dure un nombre de passages, ou jusqu'à la fin de la scène, et un événement peut la lever avant.** Le nombre de passages n'est pas un raccourci : une consigne qui tombe quand la patience atteint 0 ne sait pas à quel passage, et *trois passages plus tard* s'écrirait sans lui en un compteur, un événement qui le décrémente et un qui lève. **Toutes les consignes en vigueur s'appliquent ensemble**, deux sur le même marquage durcissant chacune ; des consignes qui se succèdent sont une nouvelle dont l'événement lève l'ancienne.
