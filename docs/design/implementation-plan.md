...
**Ce qui se prouve.** Que le micro ne s'arme jamais avant la fin de la réponse de l'IA, ni tant qu'une reprise attend. Qu'un tour interrompu est tronqué et envoyé tel quel, jamais coupé en deux tours. Qu'aucun silence ne dépasse x en troisième position. Que rien ne s'agrège entre positions de capture.

**Avec l'humain.** **Ce que chaque mesure lit** de l'audio — le brut, les segments, la reconstruction —, mesure par mesure, à écrire avant d'implémenter et non différé. Un cas y entre : une prise ouverte à la main parce qu'une reprise attendait commence à l'appui, donc son **silence initial** ne couvre pas le délai entier ; deux feuilles lisent le silence du début, le plus long silence et la continuité, et ce que ça leur fait se tranche là. Le **seuil de niveau** du retrait des plages vides, qui demande des tours spontanés hésitants que le banc n'a pas ; le seuil de durée, lui, est sûr à l'ordre de la demi-seconde, hors du domaine des phonèmes.
