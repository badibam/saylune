...
**La ligne du fil fait 59 pixels et non cinq rangées de grille**, et c'est la liberté verticale employée pour ce qu'elle est : l'arrondi mangeait les quatre pixels budgétés pour les descendantes et le halo de la courbe tombait dans la vaguelette de la ligne du dessus. Restait à savoir si un fil de lignes hors grille se lit aussi bien qu'un fil sur la grille ; lu à l'usage sur un fil long, oui (2026-09-07). Rien d'autre ne sort de la grille — les cadres, les panneaux et les marges y sont dans les deux sens, et c'est ce qui les fait composer entre eux.

**La ligne du fil fait 59 pixels et non cinq rangées de grille**, et c'est la liberté verticale employée pour ce qu'elle est : l'arrondi mangeait les quatre pixels budgétés pour les descendantes et le halo de la courbe tombait dans la vaguelette de la ligne du dessus. Restait à savoir si un fil de lignes hors grille se lit aussi bien ; lu à l'usage sur un fil long, oui (2026-09-07). Rien d'autre n'en sort — cadres, panneaux et marges tiennent la grille dans les deux sens, et c'est ce qui les fait composer entre eux.
...
**Deux sorties, dont une qui demande.** *Poursuivre* prend la séance telle qu'elle est, et s'appelle *commencer* **tant qu'aucun passage n'a été dit** — le seul écart à ce que ce doc disait. Une séance s'écrit dès que la situation est réglée, donc une tuile ouverte puis quittée avant le premier mot en a une, et *poursuivre* sur une conversation où rien n'a été dit dit faux. Ce que le bouton fait ne change pas : il ouvre cette séance vide plutôt que d'en empiler une seconde. *Recommencer* est la seule chose de l'app qui rende une séance inatteignable : l'ancienne reste en base, et tant qu'aucun écran d'historique n'existe, hors d'atteinte vaut perdue à l'usage. Elle demande donc, défaut sur non, **dans le registre plutôt que dans une boîte de dialogue** : les deux boutons deviennent la question, et la réponse est là où la main est déjà.
